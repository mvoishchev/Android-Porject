 ...
 */
public class Results_seven extends ActionBarActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.results_one);
        ...
        Recipe recipe = SearchTools.GetRecipePreviewById("Spoonacular", "682914");
